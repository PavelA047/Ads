...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        hashTable.put(new Product(51, "Kefir"), 120);
        hashTable.put(new Product(21, "Potato"), 67);
        hashTable.put(new Product(25, "Melon"), 77);
        hashTable.put(new Product(29, "Milk"), 11);
...
//        System.out.println("Cost carrot is " + hashTable.get(new Product(29, "Milk")));
//
//        hashTable.remove(new Product(21, "Potato"));
//        hashTable.remove(new Product(77, "Banana"));
//        hashTable.remove(new Product(29, "Milk"));
//        System.out.println("Size is " + hashTable.size());
//
//        hashTable.display();
//
